                            ...
                            <div class="basic-details">
                                <div class="row clearfix">
                                    <div class="image-column col-md-6 col-sm-6 col-xs-12">
                                        <figure class="image-box"><a href="images/resource/products/product13_268x303.jpg" class="lightbox-image" title="Image Caption Here"><img src="images/resource/products/product13_268x303.jpg" alt=""></a></figure>
                                    </div>
                                    <div class="info-column col-md-6 col-sm-6 col-xs-12">
                                        <div class="details-header">
                                            <h4>Dried Sheep Skin</h4>
                                            <div class="rating">
                                            ...
                                            <div class="item-price">Ksh 5,600</div>
                                        </div>

                                        <div class="text">
                                            <p>Sheep skin that has been sun dried, treated well and it's ready for anything you'd want to create with.</p>
                                        </div>
                                        ...
                                        <!--Item Meta-->
                                        <ul class="item-meta">
                                            <li><strong>Categories:</strong> <a href="#">African</a> , <a href="#">Local Products</a></li>
                                        </ul>
                            ...
                            <div class="product-info-tabs">
                                ...
                                <div class="tabs-box product-tabs" id="product-tabs">
                                    ...
                                    <ul class="tab-buttons clearfix">
                                        ...
                                        <li class="tab-btn" data-tab="#prod-reviews">Reviews (1)</li>
                                    </ul>
                                    ...
                                    <div class="tabs-content">
                                        ...
                                        <div class="tab active-tab" id="prod-description">
                                            <div class="content">
                                                <p>This product has been obtained naturally from a Kenyan indigenous sheep.</p>
                                            </div>
                                        </div>

                                        <!--Tab-->
                                        <div class="tab" id="prod-reviews">
                                            <h3>1 Reviews Found</h3>
                                            ...
                                            <div class="reviews-container">
                                                ...
                                                <article class="review-box clearfix">
                                                    ...
                                                    <div class="rev-content">
                                                        ...
                                                        <div class="rev-info">Admin – Mar 27, 2017: </div>
                                                        <div class="rev-text"><p>The best product there is, high quality.</p></div>
                                                    </div>
                                                </article>
