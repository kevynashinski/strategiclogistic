...
<!-- Mirrored from wp.hostlin.com/nijmegan/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Mar 2017 12:28:58 GMT -->
<head>
<meta charset="utf-8">
<title>Nijmegan - Factory and Industrial HTML5 Template | Checkout</title>
<!-- Stylesheets -->
    ...
    <div class="checkout-page">
        <div class="auto-container">
            ...
            <div class="billing-details">
                <div class="shop-form">
                    <form method="post" action="http://wp.hostlin.com/nijmegan/checkout.html">
                        <div class="row clearfix">
                                ...
                                <tr>
                                    <td colspan="2" class="prod-column">
                                        <div class="column-box">
                                            <figure class="prod-thumb"><img src="images/resource/products/11.jpg" alt=""></figure>
                                            <h4 class="prod-title">SAFETY GEARS</h4>
                                        </div>
                                    </td>
                                    <td class="qty"><input class="quantity-spinner" type="text" value="1" name="quantity"></td>
                                    <td class="price">$215.00</td>
                                    <td class="sub-total">$215.00</td>
                                    <td class="remove"><a href="#" class="remove-btn"><span class="flaticon-garbage"></span></a></td>
                                </tr>
                        ...
                        <div class="pull-left">
                            <div class="apply-coupon clearfix">
                                <div class="form-group clearfix">
                                    <input type="text" name="coupon-code" value="" placeholder="Enter your Coupon Code">
                                </div>
                                <div class="form-group clearfix">
                                    <button type="button" class="theme-btn btn-style-two">Apply Coupon</button>
                                </div>
                            </div>
                        </div>

                        <div class="pull-right">
                            <button type="button" class="theme-btn btn-style-six">Update Cart </button>
                        </div>
            ...
            <div class="place-order">
                ...
                <button type="button" class="theme-btn btn-style-two place-order">PLACE ORDER</button>
