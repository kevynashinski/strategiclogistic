...
<!-- Mirrored from wp.hostlin.com/nijmegan/project.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Mar 2017 12:28:30 GMT -->
<head>
<meta charset="utf-8">
<title>Nijmegan - Factory and Industrial HTML5 Template | Project</title>
<!-- Stylesheets -->
    	...
    	<div class="auto-container">
            ...
            <div class="row clearfix">
                	...
                	<div class="inner-box">
                    	<div class="image-box">
                            ...
                            <div class="overlay-box">
                            	<a href="project-single.php" class="link-box"><span class="icon fa fa-link"></span></a>
                            </div>
                        </div>
                    </div>
                </div>
            	...
            	<div class="project-block col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                    	<div class="image-box">
                        	<img src="images/resource/project-15.jpg" alt="" />
                            <div class="overlay-box">
                            	<a href="project-single.php" class="link-box"><span class="icon fa fa-link"></span></a>
                            </div>
                        </div>
            	...
            	<div class="project-block col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                    	<div class="image-box">
                        	<img src="images/resource/project-16.jpg" alt="" />
                            <div class="overlay-box">
                            	<a href="project-single.php" class="link-box"><span class="icon fa fa-link"></span></a>
                            </div>
                        </div>
            	...
            	<div class="project-block col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                    	<div class="image-box">
                        	<img src="images/resource/project-17.jpg" alt="" />
                            <div class="overlay-box">
                            	<a href="project-single.php" class="link-box"><span class="icon fa fa-link"></span></a>
                            </div>
                        </div>
...
<!-- Mirrored from wp.hostlin.com/nijmegan/project.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Mar 2017 12:28:33 GMT -->
</html>
